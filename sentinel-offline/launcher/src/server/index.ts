...
const ui=fileURLToPath(new URL("../../src/ui/",import.meta.url)),vault=new UnavailableVault(),sessions=new Map<string,LocalSession>();let locked=false;
...
const type=path.endsWith(".html")?"text/html; charset=utf-8":path.endsWith(".js")?"text/javascript; charset=utf-8":"text/css; charset=utf-8";return send(res,200,readFileSync(ui+path,"utf8"),type);
